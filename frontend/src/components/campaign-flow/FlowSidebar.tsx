            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{(selectedNode.data.analytics as ImageNodeData['analytics']).clickRate}%</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Conversion Rate</span>
                  <span className="font-medium">{(selectedNode.data.analytics as ImageNodeData['analytics']).conversionRate}%</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Engagement</span>
                  <span className="font-medium">{(selectedNode.data.analytics as ImageNodeData['analytics']).engagement}%</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Impressions</span>
                  <span className="font-medium">{(selectedNode.data.analytics as ImageNodeData['analytics']).impressions.toLocaleString()}</span>
                </div>
              </div>
            </div>
