            ...
            <div className="flex h-16 items-center border-b px-6">
                <div className="flex items-center gap-2">
                    <div
                        ...
                        <Avatar>
                            <AvatarImage src="/liquid-ads.png" alt="User"/>
                            <AvatarFallback>JD</AvatarFallback>
                        </Avatar>
                    </div>
                    <span className="text-xl font-semibold">liquid ads</span>
                </div>
            </div>
            ...
            <div className="p-4">
                <div className="flex items-center gap-3 rounded-lg p-2 hover:bg-accent">
                    <div className="size-9 rounded-sm bg-muted flex items-center justify-center">
                        <span className="text-white">JD</span></div>
                    <div className="flex flex-col">
                        <span className="text-sm font-medium">John Doe</span>
                        <span className="text-xs text-muted-foreground">jd@liquid-ads.ai</span>
                    </div>
                </div>
            </div>
        </div>
